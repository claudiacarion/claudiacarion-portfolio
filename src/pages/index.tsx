  ...
  return (
    <>
      ...
      <main className="px-5 py-12 bg-four font-quicksand" id='main'>
        ...
        The opportunity to join a bootcamp at <a href="https://www.salt.dev/" className='cursor-pointer hover:text-two'>School of Applied Technology Stockholm</a> came up and I jumped at the chance.
