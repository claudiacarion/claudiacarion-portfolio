  ...
  return (
    <>
      ...
      <main className="px-5 py-12 bg-four font-quicksand" id='main'>
        ...
        After an intensive 3-month course as one of 34 students selected from over 1000 applicants, I graduated as a fullstack JavaScript developer in December 2022.
        </p>
          </div>
          </div>
        </section>
